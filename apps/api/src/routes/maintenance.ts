...
router.post("/", requireRole("admin", "engineering_maintenance", "airport_fuel_manager"), (req, res, next) => {
  try {
...
router.post("/:id/complete", requireRole("admin", "engineering_maintenance"), (req, res, next) => {
  try {
