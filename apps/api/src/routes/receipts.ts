...
router.post("/", requireRole("admin", "airport_fuel_manager", "fuel_operator"), (req, res, next) => {
  try {
...
router.post("/:id/transition", requireRole("admin", "airport_fuel_manager", "fuel_operator", "national_fuel_manager"), (req, res, next) => {
  try {
