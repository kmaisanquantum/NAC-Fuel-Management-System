...
router.post("/", requireRole("admin", "airport_fuel_manager", "engineering_maintenance"), (req, res, next) => {
  try {
...
router.post("/:id/reading", requireRole("admin", "airport_fuel_manager", "fuel_operator", "engineering_maintenance"), (req, res, next) => {
  try {
